...
export default function HeroComponent({ picture, title, subtitle, ctaPrimary, ctaSecondary }: HeroComponentProps) {
  return (
    <section
    ...
    >
      <div className="relative w-full min-h-[75svh] bg-[var(--bg-overlay)] rounded-bl-[var(--radius-lg)] rounded-br-[var(--radius-lg)] flex flex-col gap-5 justify-center items-center text-[var(--color-white)]">
        ...
        <h2 className="text-center max-w-[75%] font-body !font-light text-xl">{subtitle}</h2>
